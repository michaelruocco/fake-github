...
* GET [http://localhost:8099/users/hackeryou](http://localhost:8099/users/hackeryou)
* GET [http://localhost:8099/users/HackerYou/repos](http://localhost:8099/users/HackerYou/repos)
* GET [http://localhost:8099/repos/HackerYou/amazon/languages](http://localhost:8099/repos/HackerYou/amazon/languages) (this is faked for all repos returned in the user repos call, amazon is just an example)
